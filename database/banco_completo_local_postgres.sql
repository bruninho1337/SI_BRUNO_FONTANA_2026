...
create table if not exists public.condicoes_pagamento (
	...
	condicao_pagamento varchar(80) not null check (char_length(condicao_pagamento) between 2 and 80),
...
create table if not exists public.formas_pagamento (
	...
	forma_pagamento varchar(80) not null unique check (char_length(forma_pagamento) between 2 and 80),
...
create table if not exists public.categorias (
	...
	categoria varchar(80) not null unique check (char_length(categoria) between 2 and 80),
	descricao text check (descricao is null or char_length(descricao) <= 255),
...
create table if not exists public.unidades_medida (
	...
	unidade_medida varchar(80) not null unique check (char_length(unidade_medida) between 2 and 80),
...
create table if not exists public.produtos (
	...
	produto varchar(80) not null check (char_length(produto) between 2 and 80),
...
create table if not exists public.servicos (
	...
	servico varchar(80) not null check (char_length(servico) between 2 and 80),
	codcategoria integer references public.categorias(codcategoria),
